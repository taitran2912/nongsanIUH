...
<head>
    ...
    <title>Nông Sản Xanh - Trang người bán</title>
    <!-- Bootstrap CSS -->
    ...
    <div class="seller-dashboard">
        ...
        <nav id="sidebar" class="sidebar">
            ...
            <ul class="nav flex-column">
                <li class="nav-item">
                    <a href="?action=dashboard" class="nav-link active" data-bs-toggle="tab">
                ...
                <li class="nav-item">
                    <a href="?action=statis" class="nav-link">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm sticky-top">
                <div class="container-fluid">
                    ...
                    <div class="d-flex align-items-center">
                        <div class="dropdown">
                            <button class="btn position-relative me-3" type="button" id="notificationsDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="products">
                        ...
                        <div class="card">
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            ...
                                                            <li><a class="dropdown-item" href="#">Nhập thêm</a></li>
                            ...
                            <div class="card-footer bg-white">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>Hiển thị 1-7 của 65 sản phẩm</div>
                    ...
                    <div class="tab-pane fade" id="orders">
                        ...
                        <div class="card">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li><a class="dropdown-item" href="#">Xem chi tiết</a></li>
                                                            <li><a class="dropdown-item" href="#">Cập nhật trạng thái</a></li>
                                                            <li><a class="dropdown-item" href="#">In hóa đơn</a></li>
                                                        </ul>
                                                    </div>
                                                </td>
                            ...
                            <div class="card-footer bg-white">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>Hiển thị 1-7 của 42 đơn hàng</div>
                                    <nav aria-label="Page navigation">
                                        <ul class="pagination mb-0">
                                            <li class="page-item disabled">
                                                <a class="page-link" href="#" aria-label="Previous">
                    ...
                    <div class="tab-pane fade" id="customers">
                        ...
                        <div class="card">
                                    ...
                                    <table class="table table-hover align-middle mb-0">
                                        ...
                                        <tbody>
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            ...
                                                            <li><a class="dropdown-item" href="#">Gửi email</a></li>
                                                            <li><hr class="dropdown-divider"></li>
                                            ...
                                            <tr>
                                                ...
                                                <td>580,000 đ</td>
                                                <td>05/04/2023</td>
                                                <td><span class="badge bg-warning text-dark">Mới</span></td>
                                                <td>
                                                    <div class="dropdown">
                                                        <button class="btn btn-sm" type="button" data-bs-toggle="dropdown">
                                                            <i class="fas fa-ellipsis-v"></i>
                            ...
                            <div class="card-footer bg-white">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>Hiển thị 1-5 của 28 khách hàng</div>
                                    <nav aria-label="Page navigation">
                                        <ul class="pagination mb-0">
                                            <li class="page-item disabled">
                                                <a class="page-link" href="#" aria-label="Previous">
                    ...
                    <div class="tab-pane fade" id="analytics">
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="card stat-card h-100">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <h6 class="card-subtitle text-muted">Tổng doanh thu</h6>
                                                <h3 class="card-title mb-0">28.5M đ</h3>
                                                <p class="card-text text-success"><i class="fas fa-arrow-up"></i> 15.2% so với tháng trước</p>
                                            </div>
                                            <div class="stat-icon bg-primary-light text-primary">
                                                <i class="fas fa-money-bill-wave"></i>
                                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="card stat-card h-100">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <h6 class="card-subtitle text-muted">Tổng đơn hàng</h6>
                                                <h3 class="card-title mb-0">142</h3>
                                                <p class="card-text text-success"><i class="fas fa-arrow-up"></i> 8.7% so với tháng trước</p>
                                            </div>
                                            <div class="stat-icon bg-success-light text-success">
                                                <i class="fas fa-shopping-bag"></i>
                                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="card stat-card h-100">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <h6 class="card-subtitle text-muted">Khách hàng mới</h6>
                                                <h3 class="card-title mb-0">28</h3>
                                                <p class="card-text text-success"><i class="fas fa-arrow-up"></i> 12.3% so với tháng trước</p>
                                            </div>
                                            <div class="stat-icon bg-info-light text-info">
                                                <i class="fas fa-users"></i>
                                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="card stat-card h-100">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <h6 class="card-subtitle text-muted">Tỷ lệ chuyển đổi</h6>
                                                <h3 class="card-title mb-0">3.2%</h3>
                                                <p class="card-text text-danger"><i class="fas fa-arrow-down"></i> 1.5% so với tháng trước</p>
                                            </div>
                                            <div class="stat-icon bg-warning-light text-warning">
                                ...
                                <div class="card h-100">
                                    <div class="card-header bg-white d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="btn-group" role="group">
                                            <button type="button" class="btn btn-sm btn-outline-secondary active">Ngày</button>
                                            <button type="button" class="btn btn-sm btn-outline-secondary">Tuần</button>
                        ...
                        <div class="row g-4 mb-4">
                            ...
                            <div class="col-lg-6">
                                <div class="card h-100">
                                    <div class="card-header bg-white">
                                        <h5 class="card-title mb-0">Khách hàng hàng đầu</h5>
                                    </div>
                                    <div class="card-body p-0">
                                        <div class="table-responsive">
                                            <table class="table table-hover align-middle mb-0">
                    ...
                    <div class="tab-pane fade" id="reviews">
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-md-3 text-center">
                                        ...
                                        <p class="text-muted mb-0">Dựa trên 128 đánh giá</p>
                                    </div>
                                    <div class="col-md-7">
                        ...
                        <div class="card">
                                    ...
                                    <div class="list-group-item p-3">
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <p class="mb-2">Rau củ rất tươi và ngon, đóng gói cẩn thận. Sẽ tiếp tục ủng hộ shop!</p>
                                                <div class="d-flex align-items-center">
                                                    <span class="badge bg-light text-dark me-2">Rau cải ngọt hữu cơ</span>
                                                    <span class="badge bg-light text-dark me-2">Cà chua hữu cơ</span>
                                                </div>
                                                <div class="mt-3">
                                                    <button class="btn btn-sm btn-outline-success me-2">Trả lời</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="list-group-item p-3">
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <p class="mb-2">Trái cây rất ngon, nhưng có vài quả hơi bị dập. Giao hàng nhanh.</p>
                                                <div class="d-flex align-items-center">
                                                    <span class="badge bg-light text-dark me-2">Táo hữu cơ</span>
                                                    <span class="badge bg-light text-dark me-2">Cam sành</span>
                                                </div>
                                                <div class="mt-3">
                                                    <button class="btn btn-sm btn-outline-success me-2">Trả lời</button>
                                                </div>
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1">
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    ...
                                                    <small class="text-muted">13/05/2023</small>
                                                </div>
                                                <div class="mb-2">
                                                    <i class="fas fa-star text-warning"></i>
                                                    <i class="fas fa-star text-warning"></i>
                                                ...
                                                <p class="mb-2">Gạo lứt hữu cơ rất ngon, nấu lên cơm dẻo và thơm. Sẽ mua lại!</p>
                                                <div class="d-flex align-items-center">
                                                    <span class="badge bg-light text-dark me-2">Gạo lứt hữu cơ</span>
                                                </div>
                                                <div class="mt-3">
                                                    <button class="btn btn-sm btn-outline-success me-2">Trả lời</button>
                                                </div>
                                    ...
                                    <div class="list-group-item p-3">
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <p class="mb-2">Bắp cải không được tươi lắm, nhưng cà rốt rất ngon. Giao hàng hơi chậm.</p>
                                                <div class="d-flex align-items-center">
                                                    <span class="badge bg-light text-dark me-2">Bắp cải</span>
                                                    <span class="badge bg-light text-dark me-2">Cà rốt</span>
                                                </div>
                                                <div class="mt-3">
                                                    <button class="btn btn-sm btn-outline-success me-2">Trả lời</button>
                                                </div>
                                                <div class="mt-3 bg-light p-3 rounded">
                                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                                        <h6 class="mb-0">Phản hồi từ Nông Sản Xanh</h6>
                                                        <small class="text-muted">12/05/2023</small>
                                                    </div>
                                                    <p class="mb-0">Chúng tôi xin lỗi vì trải nghiệm không tốt của bạn. Chúng tôi sẽ cải thiện chất lượng sản phẩm và dịch vụ giao hàng. Xin cảm ơn phản hồi của bạn!</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="list-group-item p-3">
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <p class="mb-2">Khoai lang và khoai tây rất ngon, đúng chuẩn hữu cơ. Sẽ tiếp tục ủng hộ!</p>
                                                <div class="d-flex align-items-center">
                                                    <span class="badge bg-light text-dark me-2">Khoai lang</span>
                                                    <span class="badge bg-light text-dark me-2">Khoai tây</span>
                                                </div>
                                                <div class="mt-3">
                                                    <button class="btn btn-sm btn-outline-success me-2">Trả lời</button>
                                                </div>
                            ...
                            <div class="card-footer bg-white">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>Hiển thị 1-5 của 128 đánh giá</div>
                                    <nav aria-label="Page navigation">
                                        <ul class="pagination mb-0">
                                            <li class="page-item disabled">
                                                <a class="page-link" href="#" aria-label="Previous">
                                    ...
                                    <div class="card-body">
                                        <form>
                                            <div class="mb-3 text-center">
                                                ...
                                                <div>
                                                    <button type="button" class="btn btn-sm btn-outline-primary">Thay đổi ảnh</button>
                                                </div>
                                            </div>
                                            <div class="mb-3">
                                                <label for="storeName" class="form-label">Tên cửa hàng</label>
                                                <input type="text" class="form-control" id="storeName" value="Nông Sản Xanh">
                                            </div>
                                            <div class="mb-3">
                                                <label for="storeEmail" class="form-label">Email</label>
                                                <input type="email" class="form-control" id="storeEmail" value="info@nongsanxanh.com">
                                            </div>
                                            <div class="mb-3">
                                                <label for="storePhone" class="form-label">Số điện thoại</label>
                                                <input type="tel" class="form-control" id="storePhone" value="0123456789">
                                            </div>
                                            <div class="mb-3">
                                                <label for="storeAddress" class="form-label">Địa chỉ</label>
                                                <textarea class="form-control" id="storeAddress" rows="3">123 Đường Nông Nghiệp, Quận 2, TP. Hồ Chí Minh</textarea>
                                            </div>
                                            <div class="mb-3">
                                                <label for="storeDescription" class="form-label">Mô tả cửa hàng</label>
                                                <textarea class="form-control" id="storeDescription" rows="4">Chúng tôi cung cấp các sản phẩm nông nghiệp sạch, an toàn và chất lượng cao, được trồng và thu hoạch theo tiêu chuẩn hữu cơ quốc tế.</textarea>
                                            </div>
                                            <div class="text-end">
                                        ...
                                        <form>
                                            <div class="mb-3">
                                                <div class="form-check form-switch">
                                                    ...
                                                    <label class="form-check-label" for="orderNotifications">Thông báo đơn hàng mới</label>
                                                </div>
                                            </div>
                                            <div class="mb-3">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox" id="reviewNotifications" checked>
                                                    <label class="form-check-label" for="reviewNotifications">Thông báo đánh giá mới</label>
                                                </div>
                                            </div>
                                            <div class="mb-3">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox" id="stockNotifications" checked>
                                                    <label class="form-check-label" for="stockNotifications">Thông báo sản phẩm sắp hết hàng</label>
                                                </div>
                                            </div>
                                            <div class="mb-3">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox" id="marketingNotifications">
                                                    <label class="form-check-label" for="marketingNotifications">Thông báo tiếp thị và khuyến mãi</label>
                                                </div>
                                            </div>
                                            <div class="text-end">
                                                <button type="submit" class="btn btn-success">Lưu thay đổi</button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="productPrice" class="form-label">Giá (đ)</label>
