                ...
                <table class="table table-hover align-middle mb-0" id="ordersTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div class="form-check">
                                    <input class="form-check-input order-checkbox" type="checkbox" value="ORD002">
                                </div>
                            </td>
                            <td><a href="#" class="fw-medium text-decoration-none" data-bs-toggle="modal" data-bs-target="#viewOrderModal" data-order-id="ORD002">#ORD002</a></td>
                            <td>
                                <div class="d-flex align-items-center">
                            ...
                            <td>
                                <div class="fw-medium">450,000 đ</div>
                                <div class="small text-muted">3 sản phẩm</div>
                            </td>
                            <td><span class="badge bg-success">Chuyển khoản</span></td>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#viewOrderModal" data-order-id="ORD002"><i class="fas fa-eye me-2"></i>Xem chi tiết</a></li>
                                        <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#updateStatusModal" data-order-id="ORD002"><i class="fas fa-edit me-2"></i>Cập nhật trạng thái</a></li>
                                        <li><hr class="dropdown-divider"></li>
                                        <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#printInvoiceModal" data-order-id="ORD002"><i class="fas fa-print me-2"></i>In hóa đơn</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>
                                <div class="form-check">
                                    <input class="form-check-input order-checkbox" type="checkbox" value="ORD003">
                                </div>
                            </td>
                            <td><a href="#" class="fw-medium text-decoration-none" data-bs-toggle="modal" data-bs-target="#viewOrderModal" data-order-id="ORD003">#ORD003</a></td>
                            <td>
                                <div class="d-flex align-items-center">
                            ...
                            <td>
                                <div class="fw-medium">180,000 đ</div>
                                <div class="small text-muted">2 sản phẩm</div>
                            </td>
                            <td><span class="badge bg-primary">MoMo</span></td>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#viewOrderModal" data-order-id="ORD003"><i class="fas fa-eye me-2"></i>Xem chi tiết</a></li>
                                        <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#updateStatusModal" data-order-id="ORD003"><i class="fas fa-edit me-2"></i>Cập nhật trạng thái</a></li>
                                        <li><hr class="dropdown-divider"></li>
                                        <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#printInvoiceModal" data-order-id="ORD003"><i class="fas fa-print me-2"></i>In hóa đơn</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>
                                <div class="form-check">
                                    <input class="form-check-input order-checkbox" type="checkbox" value="ORD004">
                                </div>
                            </td>
                            <td><a href="#" class="fw-medium text-decoration-none" data-bs-toggle="modal" data-bs-target="#viewOrderModal" data-order-id="ORD004">#ORD004</a></td>
                            <td>
                                <div class="d-flex align-items-center">
                            ...
                            <td>
                                <div class="fw-medium">560,000 đ</div>
                                <div class="small text-muted">6 sản phẩm</div>
                            </td>
                            <td><span class="badge bg-warning text-dark">COD</span></td>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#viewOrderModal" data-order-id="ORD004"><i class="fas fa-eye me-2"></i>Xem chi tiết</a></li>
                                        <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#updateStatusModal" data-order-id="ORD004"><i class="fas fa-edit me-2"></i>Cập nhật trạng thái</a></li>
                                        <li><hr class="dropdown-divider"></li>
                                        <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#printInvoiceModal" data-order-id="ORD004"><i class="fas fa-print me-2"></i>In hóa đơn</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>
                                <div class="form-check">
                                    <input class="form-check-input order-checkbox" type="checkbox" value="ORD005">
                                </div>
                            </td>
                            <td><a href="#" class="fw-medium text-decoration-none" data-bs-toggle="modal" data-bs-target="#viewOrderModal" data-order-id="ORD005">#ORD005</a></td>
                            <td>
                                <div class="d-flex align-items-center">
                            ...
                            <td>
                                <div class="fw-medium">290,000 đ</div>
                                <div class="small text-muted">4 sản phẩm</div>
                            </td>
                            <td><span class="badge bg-info">ZaloPay</span></td>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#viewOrderModal" data-order-id="ORD005"><i class="fas fa-eye me-2"></i>Xem chi tiết</a></li>
                                        <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#updateStatusModal" data-order-id="ORD005"><i class="fas fa-edit me-2"></i>Cập nhật trạng thái</a></li>
                                        <li><hr class="dropdown-divider"></li>
                                        <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#printInvoiceModal" data-order-id="ORD005"><i class="fas fa-print me-2"></i>In hóa đơn</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>
                                <div class="form-check">
                                    <input class="form-check-input order-checkbox" type="checkbox" value="ORD006">
                                </div>
                            </td>
                            <td><a href="#" class="fw-medium text-decoration-none" data-bs-toggle="modal" data-bs-target="#viewOrderModal" data-order-id="ORD006">#ORD006</a></td>
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="avatar-sm me-2 bg-success-light rounded-circle text-center">
                            ...
                            <td>
                                <div class="fw-medium">420,000 đ</div>
                                <div class="small text-muted">3 sản phẩm</div>
                            </td>
                            <td><span class="badge bg-success">Chuyển khoản</span></td>
                            <td><span class="badge bg-success">Đã hoàn thành</span></td>
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#viewOrderModal" data-order-id="ORD006"><i class="fas fa-eye me-2"></i>Xem chi tiết</a></li>
                                        <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#updateStatusModal" data-order-id="ORD006"><i class="fas fa-edit me-2"></i>Cập nhật trạng thái</a></li>
                                        <li><hr class="dropdown-divider"></li>
                                        <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#printInvoiceModal" data-order-id="ORD006"><i class="fas fa-print me-2"></i>In hóa đơn</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>
                                <div class="form-check">
                                    <input class="form-check-input order-checkbox" type="checkbox" value="ORD007">
                                </div>
                            </td>
                            <td><a href="#" class="fw-medium text-decoration-none" data-bs-toggle="modal" data-bs-target="#viewOrderModal" data-order-id="ORD007">#ORD007</a></td>
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="avatar-sm me-2 bg-primary-light rounded-circle text-center">
                            ...
                            <td>
                                <div class="fw-medium">350,000 đ</div>
                                <div class="small text-muted">4 sản phẩm</div>
                            </td>
                            <td><span class="badge bg-warning text-dark">COD</span></td>
                            <td><span class="badge bg-info">Đang giao hàng</span></td>
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#viewOrderModal" data-order-id="ORD007"><i class="fas fa-eye me-2"></i>Xem chi tiết</a></li>
                                        <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#updateStatusModal" data-order-id="ORD007"><i class="fas fa-edit me-2"></i>Cập nhật trạng thái</a></li>
                                        <li><hr class="dropdown-divider"></li>
                                        <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#printInvoiceModal" data-order-id="ORD007"><i class="fas fa-print me-2"></i>In hóa đơn</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div class="bulk-actions d-flex align-items-center">
                    <select class="form-select form-select-sm me-2" id="bulkActionSelect" style="width: auto;">
                        ...
                        <option value="shipping">Đánh dấu đang giao hàng</option>
                        <option value="completed">Đánh dấu đã hoàn thành</option>
